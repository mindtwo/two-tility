...
if (! function_exists('cache_key')) {
     ...
     * @param  array|null  $options - Options for the KeyGenerator instance. If null it will use the value of config('two-tility.cache.default_options'). See KeyGenerator::make() for details.
