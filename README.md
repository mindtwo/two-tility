...
```bash
composer require mindtwo/two-tility
```
...
[link-packagist]: https://packagist.org/packages/mindtwo/two-tility
[link-downloads]: https://packagist.org/packages/mindtwo/two-tility
